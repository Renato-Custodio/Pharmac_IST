...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final OkcacheLibraryAccessors laccForOkcacheLibraryAccessors = new OkcacheLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at okcache
     */
    public OkcacheLibraryAccessors getOkcache() {
        return laccForOkcacheLibraryAccessors;
    }
    ...
    public static class OkcacheLibraryAccessors extends SubDependencyFactory {

        public OkcacheLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for control (com.ncornette.cache:okcache-control)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getControl() {
                return create("okcache.control");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: okcacheControl (1.1.1)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getOkcacheControl() { return getVersion("okcacheControl"); }
